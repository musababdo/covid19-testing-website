...
?>                 
<h1 class="h3 mb-4 text-gray-800"><?php echo $row['FullName'];?> تعديل</h1>
<form name="editphlebotomist" method="post">
 ...
 <div class="form-group">
        ...
        <div class="form-group">
                                 <input type="submit" class="btn btn-primary btn-user btn-block" name="update" id="update" value="تعديل">                           
                             </div>                                        
