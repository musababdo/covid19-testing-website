...
<?php include_once('includes/sidebar.php');?>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <?php include_once('includes/topbar.php');?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">تغيير كلمه المرور</h1>
  ...
  <div class="row">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">تغيير كلمه المرور</h6>
                                </div>
                                <div class="card-body">
     <div class="form-group">
        ...
        <div class="form-group">
                                 <input type="submit" class="btn btn-primary btn-user btn-block" value="حفظ" name="submit" id="submit">                           
                             </div>                                        
