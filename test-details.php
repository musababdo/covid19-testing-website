...
$query2=mysqli_query($con,"update tbltestrecord set ReportStatus='$status',ReportUploadTime='$uploadtime' where OrderNumber='$orderid'");
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <?php include_once('includes/topbar.php');?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">تفاصيل  <?php echo intval($_GET['oid']);?></h1>
<div class="row">
<?php 
$testid=intval($_GET['tid']);
...
<!-- Test Information --->
                         <div class="col-lg-6">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">معلومات افحص</h6>
                                </div>
                                <div class="card-body">
...
<?php if($row['FinalReport']!=''):?>
  <tr>
    <th>التقرير</th> 
    <td><a href="reportfiles/<?php echo $row['FinalReport'];?>" target="_blank">تحميل</a></td>
    </tr>

    <tr>
    <th>زمن أستلام التقرير</th> 
...
<?php if($row['AssignedtoEmpId']==''): 
    ?>
      ...
      <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#assignto">عين بواسه</button>
            </div>                                        
<?php else: 
...
<button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#takeaction">الحدث</button>
<?php 
endif;
endif;?>    
                                </div>
...
<h4 align="center" style="color:red">لايوجد</h4>
         <?php } ?>           
...
<form method="post">
          <p>  <select class="form-control" name="assignto" required="true">
            <option value="">أختيار فني سحب دم</option>
        ...
        <?php } ?>
            ...
            <p>
     <input type="submit" class="btn btn-primary btn-user btn-block" name="submit" id="submit" value="حفظ">   </p> 
...
endwhile;
  ?>
            ...
            <option value="On the Way for Collection">طريقه واحده لجمع العينات</option>
            <option value="Sample Collected">العينات المجتمعه</option>
            <option value="Sent to Lab">العينات التي تم ارسالها الي المختبر</option>
            <option value="Delivered">العينات المستلمه</option>
       ...
       <!-- <p id='reportfile'> التقرير <span style="color:red; font-size:12px;">(Doc and PDF formate allowed)</span>    <input type="file" name="report" id="report"></p> -->
       <p>
<textarea name="remark" class="form-control" required="true" placeholder="ملاحظه" maxlength="500" rows="5"></textarea>  </p> 
  <p>
     <input type="submit" class="btn btn-primary btn-user btn-block" name="takeaction" value="حفظ" id="submit">   </p> 
