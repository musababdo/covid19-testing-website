        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <?php include_once('includes/topbar.php');?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">فحص الكورونا</h1>
<form name="newtesting" method="post">
  <div class="row">
                        ...
                        <div class="form-group">
                            <label>الأسم</label>
                                            <input type="text" class="form-control" id="fullname" name="fullname"  placeholder="أسمك بالكامل" pattern="[A-Za-z ]+" title="letters only" required="true">
                                        </div>
                                        <div class="form-group">
                                             <label>رقم الهاتف</label>
                                  <input type="text" class="form-control" id="mobilenumber" name="mobilenumber" placeholder="رقم الهاتف" pattern="[0-9]{10}" title="10 numeric characters only" required="true" onBlur="mobileAvailability()">
                                        ...
                                        <div class="form-group">
                                               <label>أثبات هويه</label>
                                            <input type="text" class="form-control" id="govtissuedid" name="govtissuedid" placeholder="الرقم الوطني/رخصه قياده/بطاقه قوميه" required="true">
                                        </div>
                                        <div class="form-group">
                                              <label>رقم أثبات الهويه</label>
                                            <input type="text" class="form-control" id="govtidnumber" name="govtidnumber" placeholder="رقم أثبات الهويه" required="true">
                                        </div>
                          

                               <div class="form-group">
                                              <label>العنوان</label>
                                            <textarea class="form-control" id="address" name="address" required="true" placeholder="العنوان"></textarea>
                                        </div>
 <div class="form-group">
                                              <label>الولايه</label>
                                      <input type="text" class="form-control" id="state" name="state" placeholder="الولايه" required="true">
                                        </div>
                        ...
                        <div class="col-lg-6">
                           ...
                           <div class="card shadow mb-4">
                             ...
                             <div class="form-group">
                                            ...
                                            <option value="Antigen">فحص سريع (مستضاد)</option>  
                                            <option value="RT-PCR">RT-PCR</option>
                                            <option value="CB-NAAT">فحص مصل (فحص الدم)</option>    
                                              </select>
                                        </div>

                                                      <div class="form-group">
                                            <label>فتره زمن الأختبار</label>
                                 <input type="datetime-local" class="form-control" id="birthdaytime" name="birthdaytime" class="form-control">                                        
                             </div>
                       <div class="form-group">
                                 <input type="submit" class="btn btn-primary btn-user btn-block" name="submit" id="submit" value="حفظ">                           
                             </div>
