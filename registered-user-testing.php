        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <?php include_once('includes/topbar.php');?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">بحث عن مستخدمين</h1>
...
<form method="post">
  <div class="row">
                       ...
                       <div class="form-group">
                                             <label>بحث عن طريق رقم الهاتف</label>
                                            <input type="text" class="form-control" id="regmobilenumber" name="regmobilenumber" placeholder="أدخل رقم الهاتف" pattern="[0-9]{10}" title="10 numeric characters only" required="true" maxlength="10">
                                        </div>
<div class="form-group">
                                 <input type="submit" class="btn btn-primary btn-user btn-block" name="search" value="بحث">                           
                             </div>
...
<h3 align="center" style="color:red">نتيجه البحث عن رقم الهاتف "<?php echo $_POST['regmobilenumber'];?>"</h3>
<hr />
    <?php
...
<form name="newtesting" method="post">
 ...
 <div class="form-group">
                       ...
                       <div class="form-group">
                                 <input type="submit" class="btn btn-primary btn-user btn-block" name="submit" value="حفظ">                           
                             </div>
