...
?>
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">'<?php echo $searchdata;?>' نتيجه بحث</h1>
...
?>
                                ...
                                <a href="patient-report-details.php?tid=<?php echo $row['testid'];?>&&oid=<?php echo $row['OrderNumber'];?>" class="btn btn-info btn-sm" target="blank">أظهار التفاصيل</a> 
