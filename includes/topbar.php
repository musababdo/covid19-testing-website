                                ...
                                <form class="form-inline mr-auto w-100 navbar-search">
                                    <div class="input-group">
                                        <input type="text" class="form-control bg-light border-0 small"
                                            placeholder="بحث عن" aria-label="Search"
...
while($row=mysqli_fetch_array($query)){
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="test-details.php?tid=<?php echo $row['id'];?>&&oid=<?php echo $row['OrderNumber'];?>">
                                    ...
                                    <div>
                                        ...
                                        <span class="font-weight-bold">تم ارسال عينه<?php echo $row['OrderNumber'];?></span>
                                    </div>
                                </a>
                            <?php }} else{?>
                            ...
                            <?php } ?>
                                ...
                                <a class="dropdown-item text-center small text-gray-500" href="new-test.php">اظهار الكل</a>
                            </div>
                        </li>
